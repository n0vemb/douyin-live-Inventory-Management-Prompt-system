<?php
$pageTitle = '直播出库记账 · 速录测试';
$currentPage = 'live_ledger_fast';
...
?>
<div class="page-title">直播出库记账 · 速录测试 <span class="sub" style="font-size:12px;color:var(--warning);font-weight:500">（实验副本，勿作正式入口）</span></div>
