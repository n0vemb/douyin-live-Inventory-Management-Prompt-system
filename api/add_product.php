...
$stmt = $pdo->prepare('INSERT INTO products (name, pinyin_initials, common_name, series, brand, barcode, qiandao_price, offline_price, release_date, product_description, image_url, remark, store_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
$stmt->execute([$name, $pinyinInitials, $commonName, $series, $brand, $barcode, $qiandaoPrice, $offlinePrice, $releaseDate, $productDescription, $imageUrl, $remark, $storeId]);
