...
?>
    ...
    async function loadSettings() {
        try {
            ...
            if (data.success && data.settings && data.settings.condition_types) {
                ...
                data.settings.condition_types.forEach(c => { conditionColors[c.key] = c.color; });
            }
        } catch (e) {
    ...
    function getCondStyle(key) {
        const color = conditionColors[key] || '#667eea';
    ...
    function renderSales(sales) {
        ...
        tbody.innerHTML = sales.map(s => {
            ...
            <tr>
                ...
                <td><span class="condition-badge" style="${getCondStyle(s.condition_type)}">${typeNames[s.condition_type] || s.condition_type}</span></td>
